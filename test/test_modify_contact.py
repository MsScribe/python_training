...
def test_modify_contact(app):
    ...
    new_conacts = app.contact.get_contact_list()
    assert len(old_contacts) == len(new_conacts)
    old_contacts[0] = contact
    assert sorted(old_contacts, key=ContactMainInfo.id_or_max) == sorted(new_conacts, key=ContactMainInfo.id_or_max)
...
def test_modify_contact_firstname(app):
    ...
    old_contacts[0] = contact
    print("OLDCONTACT: " + str(old_contacts))
